...
/**
 * EventCategoryTO Class Doc Comment
 *
 * @category Class
 * @package  SyncopePhpClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class EventCategoryTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventCategoryTO';
    ...
    const TYPE_PROPAGATION_TASK = 'PropagationTask';
    const TYPE_PULL_TASK = 'PullTask';
    const TYPE_PUSH_TASK = 'PushTask';
