...
class PoliciesApi {
   ...
   * @return void
   */
  public function create($type, $xSyncopeDomain, $policyTO) {
    $request = $this->createRequest($type, $xSyncopeDomain, $policyTO);
   ...
   */
  protected function createRequest($type, $xSyncopeDomain, $policyTO) {
    ...
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      ...
      // Verify the required parameter 'policyTO' is set.
    if ($policyTO === NULL || (is_array($policyTO) && count($policyTO) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $policyTO when calling create'
      );
    }

    $resourcePath = '/policies/{type}';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
  ...
  protected function delete1Request($type, $key, $xSyncopeDomain) {
    ...
    $resourcePath = '/policies/{type}/{key}';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   * @return void
   */
  public function list15($type, $xSyncopeDomain) {
    $request = $this->list15Request($type, $xSyncopeDomain);
  ...
  /**
   * Create request for operation 'list15'
   *
   * @param  string $type response type (extending PolicyTO) (required)
   * @param  string $xSyncopeDomain Type selector for requested policies (required)
   *
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function list15Request($type, $xSyncopeDomain) {
      // Verify the required parameter 'type' is set.
    if ($type === NULL || (is_array($type) && count($type) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $type when calling list15'
      );
    }
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling list15'
      );
    }
   ...
   * @return void
   */
  public function read18($type, $key, $xSyncopeDomain) {
    $request = $this->read18Request($type, $key, $xSyncopeDomain);
  ...
  /**
   * Create request for operation 'read18'
   *
   * @param  string $type response type (extending PolicyTO) (required)
   * @param  string $key policy type (required)
   * @param  string $xSyncopeDomain key of requested policy (required)
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function read18Request($type, $key, $xSyncopeDomain) {
      // Verify the required parameter 'type' is set.
    if ($type === NULL || (is_array($type) && count($type) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $type when calling read18'
      );
    }
      // Verify the required parameter 'key' is set.
    if ($key === NULL || (is_array($key) && count($key) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $key when calling read18'
      );
    }
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling read18'
      );
    }
   ...
   * @return void
   */
  public function update1($key, $type, $xSyncopeDomain, $policyTO) {
    $request = $this->update1Request($key, $type, $xSyncopeDomain, $policyTO);
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function update1Request($key, $type, $xSyncopeDomain, $policyTO) {
      // Verify the required parameter 'key' is set.
    if ($key === NULL || (is_array($key) && count($key) === 0)) {
      throw new \InvalidArgumentException(
    ...
    if ($policyTO === NULL || (is_array($policyTO) && count($policyTO) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $policyTO when calling update1'
      );
    }
