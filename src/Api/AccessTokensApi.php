...
class AccessTokensApi {
   ...
   * @return void
   */
  public function callList($xSyncopeDomain, $page = 1, $size = 25, $orderby = null) {
    $request = $this->callListRequest($xSyncopeDomain, $page, $size, $orderby);
   ...
   */
  protected function callListRequest($xSyncopeDomain, $page = 1, $size = 25, $orderby = null) {
    ...
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling callList'
      );
    }

    $resourcePath = '/accessTokens';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   *
   * @param  string $key access token key (required)
   * @param  string $xSyncopeDomain xSyncopeDomain (required)
   *
   * @throws \OpenEuropa\SyncopePhpClient\ApiException on non-2xx response
   * @throws \InvalidArgumentException
   * @return void
   */
  public function delete($key, $xSyncopeDomain) {
    $request = $this->deleteRequest($key, $xSyncopeDomain);
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function deleteRequest($key, $xSyncopeDomain) {
      // Verify the required parameter 'key' is set.
    if ($key === NULL || (is_array($key) && count($key) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $key when calling delete'
      );
    }
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling delete'
      );
    }

    $resourcePath = '/accessTokens/{key}';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   * @return void
   */
  public function login($xSyncopeDomain) {
    $request = $this->loginRequest($xSyncopeDomain);
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function loginRequest($xSyncopeDomain) {
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling login'
      );
    }

    $resourcePath = '/accessTokens/login';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   * @return void
   */
  public function logout($xSyncopeDomain) {
    $request = $this->logoutRequest($xSyncopeDomain);
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function logoutRequest($xSyncopeDomain) {
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling logout'
      );
    }

    $resourcePath = '/accessTokens/logout';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   * @return void
   */
  public function refresh($xSyncopeDomain) {
    $request = $this->refreshRequest($xSyncopeDomain);
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function refreshRequest($xSyncopeDomain) {
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling refresh'
      );
    }

    $resourcePath = '/accessTokens/refresh';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
