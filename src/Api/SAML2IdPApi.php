...
class SAML2IdPApi {
  ...
  protected function delete1Request($key, $xSyncopeDomain) {
    ...
    $resourcePath = '/saml2sp/identityProviders/{key}';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   * @return void
   */
  public function getActionsClasses1($xSyncopeDomain) {
    $request = $this->getActionsClasses1Request($xSyncopeDomain);
  ...
  /**
   * Create request for operation 'getActionsClasses1'
   *
   * @param  string $xSyncopeDomain (required)
   *
   * @throws \InvalidArgumentException
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function getActionsClasses1Request($xSyncopeDomain) {
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling getActionsClasses1'
      );
    }

    $resourcePath = '/saml2sp/identityProviders/actionsClasses';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   * @return void
   */
  public function importFromMetadata($xSyncopeDomain, $uNKNOWNBASETYPE) {
    $request = $this->importFromMetadataRequest($xSyncopeDomain, $uNKNOWNBASETYPE);
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function importFromMetadataRequest($xSyncopeDomain, $uNKNOWNBASETYPE) {
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling importFromMetadata'
      );
    }
    ...
    if ($uNKNOWNBASETYPE === NULL || (is_array($uNKNOWNBASETYPE) && count($uNKNOWNBASETYPE) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $uNKNOWNBASETYPE when calling importFromMetadata'
      );
    }

    $resourcePath = '/saml2sp/identityProviders';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   * @return void
   */
  public function list25($xSyncopeDomain) {
    $request = $this->list25Request($xSyncopeDomain);
  ...
  /**
   * Create request for operation 'list25'
   *
   * @param  string $xSyncopeDomain (required)
   *
   * @throws \InvalidArgumentException
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function list25Request($xSyncopeDomain) {
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling list25'
      );
    }
   ...
   * @return void
   */
  public function read25($key, $xSyncopeDomain) {
    $request = $this->read25Request($key, $xSyncopeDomain);
  ...
  /**
   * Create request for operation 'read25'
   *
   * @param  string $key SAML 2.0 Identity Provider&#39;s entityID (required)
   * @param  string $xSyncopeDomain (required)
   *
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function read25Request($key, $xSyncopeDomain) {
      // Verify the required parameter 'key' is set.
    if ($key === NULL || (is_array($key) && count($key) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $key when calling read25'
      );
    }
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling read25'
      );
    }
   ...
   * @return void
   */
  public function update1($key, $xSyncopeDomain, $sAML2IdPTO) {
    $request = $this->update1Request($key, $xSyncopeDomain, $sAML2IdPTO);
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function update1Request($key, $xSyncopeDomain, $sAML2IdPTO) {
      // Verify the required parameter 'key' is set.
    if ($key === NULL || (is_array($key) && count($key) === 0)) {
      throw new \InvalidArgumentException(
    ...
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      ...
      // Verify the required parameter 'sAML2IdPTO' is set.
    if ($sAML2IdPTO === NULL || (is_array($sAML2IdPTO) && count($sAML2IdPTO) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $sAML2IdPTO when calling update1'
      );
    }
