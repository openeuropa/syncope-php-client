...
class SecurityQuestionsApi {
   ...
   * @return void
   */
  public function create1($xSyncopeDomain, $securityQuestionTO) {
    $request = $this->create1Request($xSyncopeDomain, $securityQuestionTO);
   ...
   */
  protected function create1Request($xSyncopeDomain, $securityQuestionTO) {
    ...
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      ...
      // Verify the required parameter 'securityQuestionTO' is set.
    if ($securityQuestionTO === NULL || (is_array($securityQuestionTO) && count($securityQuestionTO) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $securityQuestionTO when calling create1'
      );
    }

    $resourcePath = '/securityQuestions';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
    ...
    // body params
    $_tempBody = NULL;
    if (isset($securityQuestionTO)) {
      $_tempBody = $securityQuestionTO;
    }
  ...
  protected function delete1Request($key, $xSyncopeDomain) {
    ...
    $resourcePath = '/securityQuestions/{key}';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   * @return void
   */
  public function list26($xSyncopeDomain) {
    $request = $this->list26Request($xSyncopeDomain);
  ...
  /**
   * Create request for operation 'list26'
   *
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function list26Request($xSyncopeDomain) {
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling list26'
      );
    }
   ...
   * @return void
   */
  public function read27($key, $xSyncopeDomain) {
    $request = $this->read27Request($key, $xSyncopeDomain);
  ...
  /**
   * Create request for operation 'read27'
   *
   * @param  string $key security question key to be read (required)
   * @param  string $xSyncopeDomain (required)
   *
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function read27Request($key, $xSyncopeDomain) {
      // Verify the required parameter 'key' is set.
    if ($key === NULL || (is_array($key) && count($key) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $key when calling read27'
      );
    }
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling read27'
      );
    }
   ...
   * @return void
   */
  public function readByUser($username, $xSyncopeDomain) {
    $request = $this->readByUserRequest($username, $xSyncopeDomain);
  ...
  /**
   * Create request for operation 'readByUser'
   *
   * @param  string $username username for which the security question is requested (required)
   * @param  string $xSyncopeDomain (required)
   *
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function readByUserRequest($username, $xSyncopeDomain) {
      // Verify the required parameter 'username' is set.
    if ($username === NULL || (is_array($username) && count($username) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $username when calling readByUser'
      );
    }
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling readByUser'
      );
    }

    $resourcePath = '/securityQuestions/byUser/{username}';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   * @return void
   */
  public function update1($key, $xSyncopeDomain, $securityQuestionTO) {
    $request = $this->update1Request($key, $xSyncopeDomain, $securityQuestionTO);
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function update1Request($key, $xSyncopeDomain, $securityQuestionTO) {
      // Verify the required parameter 'key' is set.
    if ($key === NULL || (is_array($key) && count($key) === 0)) {
      throw new \InvalidArgumentException(
    ...
    if ($securityQuestionTO === NULL || (is_array($securityQuestionTO) && count($securityQuestionTO) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $securityQuestionTO when calling update1'
      );
    }
