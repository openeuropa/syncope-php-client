...
class DynamicRealmsApi {
   ...
   * @return void
   */
  public function create($xSyncopeDomain, $dynRealmTO) {
    $request = $this->createRequest($xSyncopeDomain, $dynRealmTO);
   ...
   */
  protected function createRequest($xSyncopeDomain, $dynRealmTO) {
    ...
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      ...
      // Verify the required parameter 'dynRealmTO' is set.
    if ($dynRealmTO === NULL || (is_array($dynRealmTO) && count($dynRealmTO) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $dynRealmTO when calling create'
      );
    }

    $resourcePath = '/dynRealms';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   * @return void
   */
  public function list9($xSyncopeDomain) {
    $request = $this->list9Request($xSyncopeDomain);
  ...
  /**
   * Create request for operation 'list9'
   *
   * @param  string $xSyncopeDomain (required)
   *
   * @throws \InvalidArgumentException
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function list9Request($xSyncopeDomain) {
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling list9'
      );
    }
   ...
   * @return void
   */
  public function read9($key, $xSyncopeDomain) {
    $request = $this->read9Request($key, $xSyncopeDomain);
  ...
  /**
   * Create request for operation 'read9'
   *
   * @param  string $key dynamic realm key to be read (required)
   * @param  string $xSyncopeDomain (required)
   *
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function read9Request($key, $xSyncopeDomain) {
      // Verify the required parameter 'key' is set.
    if ($key === NULL || (is_array($key) && count($key) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $key when calling read9'
      );
    }
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling read9'
      );
    }
   ...
   * @return void
   */
  public function update($key, $xSyncopeDomain, $dynRealmTO) {
    $request = $this->updateRequest($key, $xSyncopeDomain, $dynRealmTO);
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function updateRequest($key, $xSyncopeDomain, $dynRealmTO) {
      // Verify the required parameter 'key' is set.
    if ($key === NULL || (is_array($key) && count($key) === 0)) {
      throw new \InvalidArgumentException(
    ...
    if ($dynRealmTO === NULL || (is_array($dynRealmTO) && count($dynRealmTO) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $dynRealmTO when calling update'
      );
    }
