...
class SCIMConfApi {
   ...
   * @return void
   */
  public function get1($xSyncopeDomain) {
    $request = $this->get1Request($xSyncopeDomain);
   ...
   */
  protected function get1Request($xSyncopeDomain) {
    ...
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $xSyncopeDomain when calling get1'
      );
    }

    $resourcePath = '/scimv2conf';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
   ...
   *
   * @param  string $xSyncopeDomain SCIM configuration (required)
   * @param  \SyncopePhpClient\Model\SCIMConf $sCIMConf sCIMConf (required)
   *
   * @throws \SyncopePhpClient\ApiException on non-2xx response
   * @throws \InvalidArgumentException
   * @return void
   */
  public function set($xSyncopeDomain, $sCIMConf) {
    $request = $this->setRequest($xSyncopeDomain, $sCIMConf);
   ...
   *
   * @param  string $xSyncopeDomain SCIM configuration (required)
   * @param  \SyncopePhpClient\Model\SCIMConf $sCIMConf (required)
   *
   * @throws \InvalidArgumentException
   *
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function setRequest($xSyncopeDomain, $sCIMConf) {
      // Verify the required parameter 'xSyncopeDomain' is set.
    if ($xSyncopeDomain === NULL || (is_array($xSyncopeDomain) && count($xSyncopeDomain) === 0)) {
      throw new \InvalidArgumentException(
      ...
      // Verify the required parameter 'sCIMConf' is set.
    if ($sCIMConf === NULL || (is_array($sCIMConf) && count($sCIMConf) === 0)) {
      throw new \InvalidArgumentException(
        'Missing the required parameter $sCIMConf when calling set'
      );
    }
