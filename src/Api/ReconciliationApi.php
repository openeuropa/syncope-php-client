...
class ReconciliationApi {
   ...
   * @param  \SyncopePhpClient\Model\PullTaskTO $pullTaskTO pullTaskTO (required)
   *
   ...
   * @param  string $resourceKey resource key (required)
   * @param  string $xSyncopeDomain pull specification (required)
   * @param  \SyncopePhpClient\Model\PullTaskTO $pullTaskTO (required)
   *
   * @throws \InvalidArgumentException
   *
   ...
   * @param  \SyncopePhpClient\Model\PushTaskTO $pushTaskTO pushTaskTO (required)
   *
   * @throws \SyncopePhpClient\ApiException on non-2xx response
   * @throws \InvalidArgumentException
   * @return void
   ...
   * @param  string $resourceKey resource key (required)
   * @param  string $xSyncopeDomain push specification (required)
   * @param  \SyncopePhpClient\Model\PushTaskTO $pushTaskTO (required)
   *
   * @throws \InvalidArgumentException
   *
   * @return \GuzzleHttp\Psr7\Request
